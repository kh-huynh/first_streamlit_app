...
#Index mis sur la colonne Fruit
...
def insert_row_snowflake(new_fruit):
    with my_add_cnx.cursor() as my_add_cur:
         my_add_cur.execute("insert into fruit_load_list values('"+new_fruit+"')")
         return "Thanks for adding new fruit = " + new_fruit
            
#Add button for Load the fruit
